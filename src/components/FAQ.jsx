...
const faqs = [
  {
    q: '本当に月間22,000コールされますか？',
    a: 'はい、22,000コールを保証しています。人で換算すると約5人分の稼働量です（※人の場合：200コール/日 × 22日 = 約4,400コール）。毎日のコール数はリアルタイムで共有されるため、進捗をいつでも確認できます。万が一、月間コール数が保証に満たなかった場合は翌月に繰り越し対応いたします。',
  },
  {
    q: 'どんな業種に対応していますか？',
  ...
  },
  {
    ...
    a: '営業経験15年以上のプロが、貴社の商材・ターゲットに合わせてトークツリーを設計します。新人3ヶ月レベルの無駄のない会話構成に、トップ営業マンの間・語尾・テンションを組み合わせた設計思想です。作成費用は月額料金に含まれており、運用データをもとに継続的に改善していきます。',
  },
  {
    q: '最低契約期間はありますか？',
  ...
  {
    q: '初期費用はかかりますか？',
    a: '初期費用は一切かかりません。トークツリー設計・ターゲットリスト作成・専任担当者の配置まで、すべて月額14万円に含まれています。',
  },
  {
    q: '人の営業と比べてどのくらいコスト削減できますか？',
    a: '人を雇う場合、給与だけでなく社会保険（約15%）・交通費（約1万円/月）・残業/有給コスト（約10%増）・教育コスト・管理コストがかかります。さらに最大のリスクは離職です。テレモなら離職なし・教育不要・パフォーマンス一定で、月14万円で営業5人分の稼働を実現します。',
  },
  {
    q: 'どのくらいで成果が出ますか？',
    a: '業種やターゲットによりますが、多くの場合1〜2週間で最初のアポイントが発生しています。月間22,000コールの実行量があるため、短期間でPDCAを回すことが可能です。',
  },
  {
            ...
            >
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4 pr-4">
                  <span className="text-[15px] sm:text-[16px] font-black text-[#41ac86] mt-0.5 shrink-0">Q.</span>
                  <span className="text-[15px] sm:text-[17px] font-bold text-black leading-[1.5]">{faq.q}</span>
                </div>
                <span
                  className="text-[20px] text-[#41ac86] shrink-0 transition-transform duration-300"
