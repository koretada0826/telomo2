...
const faqs = [
  ...
  {
    q: '初期費用はかかりますか？',
    a: '初期費用は一切かかりません。トークツリー設計・ターゲットリスト作成・専任担当者の配置まで、すべて月額28万円に含まれています。',
  },
  {
    q: '人の営業と比べてどのくらいコスト削減できますか？',
    a: '人を雇う場合、給与だけでなく社会保険（約15%）・交通費（約1万円/月）・残業/有給コスト（約10%増）・教育コスト・管理コストがかかります。さらに最大のリスクは離職です。TELEMOなら離職なし・教育不要・パフォーマンス一定で、月28万円で営業2人分の稼働を実現します。',
  },
  {
    q: 'どのくらいで成果が出ますか？',
