      ...
      <div className="flex items-center gap-6 sm:gap-8 mb-5">
        {[0, 0.3, 0.6].map((delay, i) => (
          <div key={i} style={{ animation: 'phone-ring 1.5s ease-in-out infinite', animationDelay: `${delay}s` }}>
            <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#41ac86" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="w-[240px] sm:w-[300px]">
        ...
        <div className="w-full h-[3px] bg-white/10 rounded-full overflow-hidden">
          <div
            ...
            style={{
              width: `${progress}%`,
              background: 'linear-gradient(90deg, #41ac86, #41ac86)',
            }}
          />
        </div>
      </div>
